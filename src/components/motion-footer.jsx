...
.footer-giant-bg-text {
  font-size: 40vw; /* Larger on mobile */
  line-height: 0.75;
  font-weight: 900;
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Cinematic Vision</span> <span className="text-primary/60">✦</span>
    <span>Creative Direction</span> <span className="text-secondary/60">✦</span>
    <span>Post Production</span> <span className="text-primary/60">✦</span>
    <span>Immersive Experiences</span> <span className="text-secondary/60">✦</span>
    <span>Visual Storytelling</span> <span className="text-primary/60">✦</span>
  </div>
);
  ...
  return (
    <>
      ...
      */}
      <div
        ref={wrapperRef}
        className="relative h-screen w-full -mt-[2.5rem] z-0"
        ...
        <footer
          ...
          <div
            className="footer-aurora absolute left-1/2 top-1/2 h-[60vh] w-[80vw] -translate-x-1/2 -translate-y-1/2 animate-footer-breathe rounded-[50%] blur-[80px] pointer-events-none z-0" />
          ...
          <div
            className="absolute top-12 left-0 w-full overflow-hidden border-y border-border/50 bg-background/60 backdrop-blur-md py-4 z-10 -rotate-2 scale-110 shadow-2xl">
            <div
              className="flex w-max animate-footer-scroll-marquee text-xs md:text-sm font-bold tracking-[0.3em] text-muted-foreground uppercase">
              <MarqueeItem />
              <MarqueeItem />
            </div>
          </div>
          ...
          <div className="relative z-20 w-full pb-12 md:pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
            
            {/* Copyright */}
            {/* <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase md:flex-1 text-center md:text-left">
              © 2026 Emad. All rights reserved.
            </div> */}

            {/* "Made with Love" Badge - Strictly Centered */}
            {/* <div className="flex justify-center md:absolute md:left-1/2 md:-translate-x-1/2">
              <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 cursor-default border-border/50">
                ...
                <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">Emad</span>
              </div>
            </div> */}

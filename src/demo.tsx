...
const sampleImages = [
  ...
  return (
    <main className="w-full overflow-x-hidden bg-[#050505]">
			<div className="relative w-full h-screen">
				<InfiniteGallery
					...
					className="w-full h-full overflow-hidden px-16 md:px-32"
				/>
				...
				<div className="text-center fixed bottom-10 left-0 right-0 font-mono uppercase text-[11px] font-semibold z-40 pointer-events-none">
			...
			{/* Spacer to make footer visible when scrolled fully */}
			<div className="relative w-full h-screen bg-[#050505] z-20"></div>
		</main>
	);
}
